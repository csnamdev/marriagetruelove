...
<div id="banner-area">
  ...
  <div  style="width:100%">
    <div class="row">
      <div class="col-sm-3 col-md-6 col-lg-4" style="background-color:#EEEEEE;" >
<?php
...
<?php
					if(isset($_POST['search']) || isset($_POST['search2'])){
						...
						$_SESSION["with_photo"] = $_POST['with_photo'];
						...
						$_SESSION["maritalstatus"] = "any";
						$_SESSION["state"] = "any";
						$_SESSION["religion"] = "any";
						$_SESSION["mothertounge"] = "any";
						
						$sql_gender="SELECT gender FROM users where id=$id";
	   ...
	   <center><label style="color:red;font-size:18px;text-align:center;width:50%" >Refine Your Search </label></center>
		<table>
					...
					<tr width="100%"height="50px">
						<td width="35%" align="right">
							<label  for="sex" >photo : </label>
						</td>
						<td width="60%" style="padding-left: 20px;">
					 <?php if($_SESSION['with_photo']=="with_photo"){
					     ?>
					     <input type="radio" id="without_photo" name="with_photo"  value="without_photo">
                      <label >Without Photo</label>
                      <input type="radio" id="with_photo" name="with_photo" style="margin-left:10px;" checked value="with_photo">
                      <label >With Photo</label><br>
					     
					 <?php
					 }else{
					     ?>
					     <input type="radio" id="without_photo" name="with_photo" checked value="without_photo">
                      <label >Without Photo</label>
                      <input type="radio" id="with_photo" name="with_photo" style="margin-left:10px;" value="with_photo">
                      <label >With Photo</label><br>
		...
		<?php
			...
			$sex=$_SESSION["sex"];
					...
					if($maritalstatus=="any" && $state=="any" && $religion=="any"){
					            ...
					            if($_POST['with_photo']=="with_photo"){
					                
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE (age BETWEEN '$agemin' AND '$agemax')  AND sex='$sex' AND photo_status = 1");
					               }else{
								    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE (age BETWEEN '$agemin' AND '$agemax') AND sex='$sex'");
								...
								if($_POST['with_photo']=="with_photo"){
								    $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND photo_status=1 ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}else{
								    $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}
								 ...
								 if($_POST['with_photo']=="with_photo"){
					                ...
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND religion = '$religion' AND photo_status=1");
					               }else{
								...
								//echo $total_records;
								if($_POST['with_photo']=="with_photo"){
								    $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND religion = '$religion' AND photo_status=1 ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}else{
								    $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND religion = '$religion' ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}
								
								//$result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
					
								
					}elseif($maritalstatus=="any" && $state!="any" && $religion=="any"){
					            if($_POST['with_photo']=="with_photo"){
					                
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND photo_status=1");
					                }else{
								...
								//echo $total_records;
									if($_POST['with_photo']=="with_photo"){
								   $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND photo_status=1 ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}else{
								   $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' ORDER BY cust_id DESC LIMIT $offset, $total_records_per_page");
								}
								//$result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
					
								
					}elseif($maritalstatus=="any" && $state!="any" && $religion!="any"){
						                   if($_POST['with_photo']=="with_photo"){
					                
        					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND religion = '$religion' AND photo_status=1");
        					                }else{
										...
										//echo $total_records;
											if($_POST['with_photo']=="with_photo"){
								                 $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND religion = '$religion' AND photo_status=1 ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }else{
								                $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }
										//$result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
					                ...
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND photo_status=1");
					                }else{
									...
									//echo $total_records;
									if($_POST['with_photo']=="with_photo"){
								                 $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND photo_status=1 ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }else{
								                $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }
					                ...
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND religion = '$religion' AND photo_status=1");
					                }else{
								...
								//	$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND religion = '$religion'");
									...
									//echo $total_records;
									if($_POST['with_photo']=="with_photo"){
								                 $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND religion = '$religion' AND photo_status=1 ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }else{
								                $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }
									//$result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
					                ...
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND state = '$state' AND photo_status=1");
					                }else{
									...
									//echo $total_records;
									if($_POST['with_photo']=="with_photo"){
								                 $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND state = '$state' AND photo_status=1 ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								     }else{
								               $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND state = '$state' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }
								//	$result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND maritalstatus = '$maritalstatus' AND state = '$state' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
					                ...
					                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM customer WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND maritalstatus = '$maritalstatus' AND religion = '$religion' AND photo_status=1");
					                }else{
									...
									//echo $total_records;
									if($_POST['with_photo']=="with_photo"){
								                 $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND maritalstatus = '$maritalstatus' AND religion = '$religion' AND photo_status=1 ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }else{
								                $result = mysqli_query($con,"SELECT * FROM `customer` WHERE age>='$agemin' AND age<='$agemax' AND sex='$sex' AND state = '$state' AND maritalstatus = '$maritalstatus' AND religion = '$religion' ORDER BY profilecreationdate DESC LIMIT $offset, $total_records_per_page");
								            }
