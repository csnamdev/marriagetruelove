    ...
    <div class="container overflow-hidden">
      ...
      <div class="multisteps-form">
        ...
        <div class="row">
          <div class="col-12 col-lg-12 ml-auto mr-auto mb-4">
            <div class="multisteps-form__progress">
              ...
              <button class="multisteps-form__progress-btn" type="button" title="Comments">Upload Signature        </button>
        ...
        <div class="row">
		  ...
		  <form class="multisteps-form__form" action="admission_function.php" method="post" enctype="multipart/form-data">
           <!-- <form class="multisteps-form__form" name="admission_form" method="post" action="admission_function.php">
              single form panel-->
                ...
                <div class="multisteps-form__content">
				  ...
				  <div class="form-row mt-4">
					...
					<label for="boarding_category">Boarding Category:</label>
                      	<select class="form-control" name="boarding_cat" id="boarding_cat">
											<option value="Dayboarder">Dayboarder</option>
					...
					<label for="school_bus">School Bus:</label>
                     	<select class="form-control" name="school_bus" id="school_bus">
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="multisteps-form__content">
				  ...
				  <h3 class="multisteps-form__title" style="margin-top:30px;">Bank Details(Father/Mother/Student)</h3>
					<div class="form-row mt-4">
						<div class="col-12 col-sm-6">
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="multisteps-form__content">
				 ...
				 <!-- <p style="color:red"><br><input type="checkbox" name="checkfield" id="g01-01"  onchange="doalert(this)"/> Check if present address is same as permanent address<p>
				    Permanent Address-->
              ...
              <!--single form panel-->
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                <h3 class="multisteps-form__title">Parents Signature</h3>
                <div class="multisteps-form__content">
                  <div class="row">
                    <div class="col-12 col-md-4 mt-4">
                      <div class="card shadow-sm">
                        <div class="card-body">
							<center><img src="PARENTS_SIGN.png" id="parents_sign_img_tag"style="margin-top:20px"width="310" height="170"></center>
							<label for="photo">Parents Signature:</label>
							<input type="file" class="form-control" name="parents_sign_img" onchange="parents_sign_img_(event)" id="parents_sign_img"></div>
							<script type="text/javascript">
								function parents_sign_img_(event) 
									{
										 var reader = new FileReader();
										 reader.onload = function()
										 {
										  var output = document.getElementById('parents_sign_img_tag');
										  output.src = reader.result;
										 }
										 reader.readAsDataURL(event.target.files[0]);
									}
				  ...
				  <h4 style="color:red;">Online Pay Rs. 200 for admission form</h4><br>
                  <div class="button-row d-flex mt-4">
                    <button class="btn btn-primary js-btn-prev" type="button" title="Prev">Prev</button>
					
					<!-- <button type="submit" name="review_form" class="btn btn-success ml-auto">Pay</button> -->
                    
					<button type="submit" name="submit_alumini" class="btn btn-success ml-auto">Pay</button>
