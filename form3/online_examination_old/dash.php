...
<title>Gyanodaya || DASHBOARD </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Gyanodaya Schoool Khurai</span></div>
<?php
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Class</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Paper Details</b></span><br /><br />
