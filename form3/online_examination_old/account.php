...
while($row = mysqli_fetch_array($result)) {
    ...
    $time = $row['time'];
	$eid = $row['eid'];
$q12=mysqli_query($con,"SELECT score FROM history WHERE eid='$eid' AND mob='$mob'" )or die('Error98');
...
{
$eid=@$_GET['eid'];
$q=mysqli_query($con,"SELECT * FROM history WHERE eid='$eid' AND mob='$mob' " )or die('Error157');
...
$q=mysqli_query($con,"SELECT * FROM rank WHERE  mob='$mob' " )or die('Error157');
while($row=mysqli_fetch_array($q) )
{
$s=$row['score'];
...
if(@$_GET['q']== 2) 
{
$q=mysqli_query($con,"SELECT * FROM history WHERE mob='$mob' ORDER BY date DESC " )or die('Error197');
...
$e=$row['mob'];
$s=$row['score'];
$q12=mysqli_query($con,"SELECT * FROM user WHERE mob='$e' " )or die('Error231');
