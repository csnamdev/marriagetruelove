...
<!--PEN HEADER-->
<header class="header">
  <h1 class="header__title" style="color:blue;">Admission Form</h1>
  </header>
<!--PEN CONTENT     -->
<div class="content">
  <!--content inner-->
            ...
            <form class="multisteps-form__form" name="admission_form" method="post" action="admission_function.php">
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                ...
                <div class="multisteps-form__content">
                  <div class="form-row mt-4">
                    <div class="col-12 col-sm-4">
                      <input class="multisteps-form__input form-control"  type="text" required id="fname" name="fname" placeholder="First Name"/>
                    </div>
					<div class="col-12 col-sm-4 mt-4 mt-sm-0">
                      <input class="multisteps-form__input form-control" type="text" id="mname" name="lname" placeholder="Middle Name"/>
                    </div>
                    <div class="col-12 col-sm-4 mt-4 mt-sm-0">
                      <input class="multisteps-form__input form-control" type="text" id="lname" required name="lname" placeholder="Last Name"/>
                    </div>
                  </div>
				  <div class="form-row mt-4">
					  <div class="col-12 col-sm-4">
				  ...
				  <div class="form-row mt-4">
					...
					<label for="school_bus">School Bus:</label>
                      <input class="multisteps-form__input form-control" type="school_bus" id="school_bus" name="caste" placeholder="School Bus"/>
                    </div>
                ...
                <label for="photo">Upload Student Photo:</label>
    				<input type="file" name="stu_photo" id="stu_photo" onchange="stu_photo_(event)">
						...
						function stu_photo_(event) 
{
			  ...
			  <div class="row">
                  ...
                  <div class="button-row d-flex mt-4">
                    <button class="btn btn-primary js-btn-prev" type="button" title="Prev">Prev</button>
					<button class="btn btn-success ml-auto" type="button" title="Send">Review</button>
					<input class="btn btn-success ml-auto" type="submit">
                    <button type="submit" name="submit_alumini" class="btn btn-default">Submit</button>
					 <button type="submit" name="submit_alumini" class="btn btn-success ml-auto">Submit2</button>
                  </div>
                </div>
