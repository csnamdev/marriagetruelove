		...
		<div class="row" >
			<div class="col-md-12 mx-auto" >
				<div class="pro-block text-center" style="padding: 40px 50px; background: white; box-shadow: 0px 2px 28px 0px #7777775e; border-radius: 5px;">
					<h1 style="font-size: 25px; line-height: 1; font-weight: 600;">Complete Your Registration</h1>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" placeholder="Email-ID" name="email" id="email" value="<?php echo isset($_POST["email"]) ? $_POST["email"] : ''; ?>"  type="email" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" placeholder="First Name" name="fname" value="<?php echo isset($_POST["fname"]) ? $_POST["fname"] : ''; ?>"id="fname"  type="text" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								
								<input class="form-control" style="border-radius: 25px;" name="lname" value="<?php echo isset($_POST["lname"]) ? $_POST["lname"] : ''; ?>" id="lname" placeholder="Last Name" type="text" required>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="sex" style="border-radius: 25px;" value="<?php echo isset($_POST["sex"]) ? $_POST["sex"] : ''; ?>" class="form-control" required>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="maritialstatus" style="border-radius: 25px;"  class="form-control" required>
				...
				<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" name="district" id="district" value="<?php echo isset($_POST["city"]) ? $_POST["city"] : ''; ?>" placeholder="Home Town" type="text" required>
							</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" placeholder="Address" name="address" id="address"  type="text" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								
								<input class="form-control" style="border-radius: 25px;" name="mobno" value="<?php echo isset($_POST["mobno"]) ? $_POST["mobno"] : ''; ?>" id="mobno" placeholder="Mobile Number" type="text" required>
							</div>
						</div>
