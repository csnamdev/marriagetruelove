		...
		<div class="row" >
			<div class="col-md-12 mx-auto" >
				<div class="pro-block text-center" style="padding: 40px 50px; background: white; box-shadow: 0px 2px 28px 0px #7777775e; border-radius: 5px;">
					<h1 style="font-size: 25px; line-height: 1; font-weight: 600;">Registration</h1>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" placeholder="First Name" name="fname" id="fname"  type="text" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								
								<input class="form-control" style="border-radius: 25px;" name="lname" id="lname" placeholder="Last Name" type="text" required>
							</div>
						</div>
				...
				<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" name="district" id="district" placeholder="Home Town" type="text" required>
							</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" style="border-radius: 25px;" name="mobno" id="mobno" placeholder="Mobile Number" type="text" required>
							</div>
						</div>
